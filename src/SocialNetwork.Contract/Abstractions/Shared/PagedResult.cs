...
namespace SocialNetwork.Contract.Abstractions.Shared
{
    public class PagedResult<T>
    {
        ...
        public static PagedResult<T> Create(List<T> items, int pageIndex, int pageSize, int totalCount) => new(items, pageIndex, pageSize, totalCount);
